...
map("n", "<leader>sf", function()
  require("config.profiles.nvim_ide.herdr").send_buffer()
end, { desc = "Send full buffer" })
map("n", "<leader>sl", function()
  require("config.profiles.nvim_ide.herdr").send_line()
end, { desc = "Send line" })
map("n", "<leader>sp", function()
  require("config.profiles.nvim_ide.herdr").send_paragraph()
end, { desc = "Send paragraph" })
map("n", "<leader>s<CR>", "<cmd>HerdrSetPane<CR>", { desc = "Set Herdr target pane" })
